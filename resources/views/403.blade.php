    ...
    <div class="max-w-3xl flex flex-col mx-auto size-full h-screen">
      ...
      <header class="mb-auto flex justify-center z-50 w-full py-4">
        <nav class="px-4 sm:px-6 lg:px-8">
          <a class="flex-none text-xl font-semibold sm:text-3xl" href="#" aria-label="Brand">SPP Online</a>
        </nav>
      </header>
      <!-- ========== END HEADER ========== -->
      ...
      <main id="content">
        <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
          <h1 class="block text-7xl font-bold text-gray-800 sm:text-9xl">403</h1>
          <p class="mt-3 text-gray-600">Forbidden.</p>
