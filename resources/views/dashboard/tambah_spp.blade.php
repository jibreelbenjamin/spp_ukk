<x-app :halaman='$title' :page='$page'>
  <form action="{{ route('spp.save') }}" method="post">
    <div>
      @csrf
      ...
      <div class="mb-5 first:pt-0 last:pb-0">
        ...
        <div class="mt-2 space-y-3">
          <input id="af-payment-billing-contact" type="number" value="{{ old('nominal') }}" name="nominal" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" autocomplete="off" placeholder="Masukan nominal spp">
        </div>
      </div>
    </div>
