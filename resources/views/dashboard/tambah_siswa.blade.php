    ...
    <div>
      ...
      <div class="mb-5 first:pt-0 last:pb-0">
        ...
        <div class="mt-2 space-y-3">
          <input id="af-payment-billing-contact" type="number" value="{{ old('nisn') }}" name="nisn" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" autocomplete="off" placeholder="Masukan NISN">
        </div>
      </div>
      ...
      <div class="mb-5 first:pt-0 last:pb-0">
        ...
        <div class="mt-2 space-y-3">
          <input id="af-payment-billing-contact" type="text" value="{{ old('nis') }}" name="nis" class="py-1.5 sm:py-2 px-3 pe-11 block w-full border-gray-200 shadow-2xs sm:text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" autocomplete="off" placeholder="Masukan NIS">
        </div>
      </div>
